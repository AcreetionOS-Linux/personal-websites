...
# SteinOS variant profile — derived from AcreetionOS base profiledef.sh
# (only overrides the identity fields; the base provides the machinery)

iso_name="SteinOS"
iso_label="steinos_$(date --date="@${SOURCE_DATE_EPOCH:-$(date +%s)}" +%Y%m)"
iso_publisher="SteinOS Project · Green Edition — built on AcreetionOS"
iso_application="SteinOS Install Media — PEOPLE · PLANET · PEACE"
iso_version="1.0.0"
install_dir="arch"
buildmodes=('iso')
